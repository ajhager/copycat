...
07/01/09
The first phase was is now complete.  It consisted of discovering the code
by doing a rough conversion of the code to Python.  The intent was to get a
better idea of the overall structure of the project and the dependencies of
each module.

Phase two is now starting. The focus will be on moulding the rough cut into
